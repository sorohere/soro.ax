...
export function Me() {
    return (
        <article className="prose prose-invert max-w-none">
            ...
            <h3>The Moment Everything Changed: Perceptrons and Gradient Descent</h3>
            <p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 my-8">
                <div className="flex flex-col items-center">
                    <Image src="/images/bg01-01.png" alt="Perceptron Diagram" width={400} height={300} className="rounded-lg" />
                    <p className="text-sm text-muted-foreground mt-2 text-center">
                        (source: <a href="https://www.ultralytics.com/blog/perceptrons-and-neural-networks-basic-principles-of-computer-vision" target="_blank" rel="noopener noreferrer">ultralytics/AbiramiVina</a>) <br />simple perceptron: inputs, weights, bias, and activation function.
                    </p>
                </div>
                <div className="flex flex-col items-center">
                    <Image src="/images/bg01-02.png" alt="Gradient Descent Diagram" width={400} height={300} className="rounded-lg" />
                    <p className="text-sm text-muted-foreground mt-2 text-center">
            ...
            <p>
                ...
                <br /><br />
                TL;DR: Machine learning is equal parts frustrating and fascinating. It’s about debugging at 2 a.m., arguing with chatbots, and wondering if AI will ever be creative. But mostly, it’s about curiosity, experimentation, and the thrill of discovering something new. Also, <a href="https://playground.tensorflow.org/" target="_blank" rel="noopener noreferrer">neural networks</a> might be judging us. Just saying.
            </p>

            <p>BTW, I’m Saurabh, my friends call me soro.</p>
        </article>
    );
}
